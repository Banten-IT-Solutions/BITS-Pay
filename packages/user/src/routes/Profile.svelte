...
<div class="space-y-5 sm:space-y-6">
  {#if loading}
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
      <Card class="p-6">
        <div class="mx-auto h-16 w-16 animate-pulse rounded-full bg-surface-2"></div>
        <div class="mx-auto mt-4 h-5 w-32 animate-pulse rounded bg-surface-2"></div>
      </Card>
  ...
  {:else if me}
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <!-- Kolom Kanan: Form Profil & Kata Sandi -->
      <div class="space-y-6 lg:col-span-2">
