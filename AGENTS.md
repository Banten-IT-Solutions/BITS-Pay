...
**Sudah lengkap:** E2E (Playwright, `pnpm test:e2e`), load test (`pnpm load-test`), monitoring runbook (`docs/MONITORING.md` + uptime.yml), deploy guide (`docs/MULTI_WORKER.md`).
